...
/obj/item/clothing/ears/earrings
	...
	species_restricted = list(SPECIES_HUMAN, SPECIES_VOX, SPECIES_VULPKANIN, SPECIES_TAJARAN, SPECIES_DIONA, SPECIES_DRASK, SPECIES_SLIMEPERSON, SPECIES_SKRELL, SPECIES_MACHINEPERSON, SPECIES_MOTH, SPECIES_NUCLEATION, SPECIES_SWINE)
