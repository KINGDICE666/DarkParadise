...
// Лавка невидима: нутро борта — цельная иллюстрация, скамьи на ней уже нарисованы, и
// спрайт поверх давал вторую табуретку прямо на нарисованной. Гасим альфой, а не
// icon = null: без картинки у объекта нет габаритов, а значит и цели для мыши — на такое
// сиденье не сядешь. MOUSE_OPACITY_OPAQUE берёт клетку целиком, чтобы попадать по
// невидимому.
