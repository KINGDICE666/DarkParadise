...
//
// Скорость берётся из общесерверных навыков, а не из своих трейтов: у санитара
// «Лечение» на легенде, у сапёра — «Строительство» с «Конструированием». Легендарный
// уровень как раз и означает половину времени (см. speed_modifiers в skills/_skill.dm),
// то есть ровно то ускорение, ради которого трейты и заводились. Выдаются уровни в
// deploy_member, см. teams.dm.
