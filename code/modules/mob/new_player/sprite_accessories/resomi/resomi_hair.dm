// ===================================================================
// RESOMI HAIRSTYLES (plumage)
// Ported from SierraBay12 mods/resomi/code/datum/gear.dm
// Paradise appends "_s" to icon_state; the dmi states already carry it.
// ===================================================================
...
/datum/sprite_accessory/hair/resomi/plumage
	name = "Resomi Plumage"
