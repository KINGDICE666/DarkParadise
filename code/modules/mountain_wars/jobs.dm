...
//
// На билде с системой навыков этих процов нет: там то же ускорение даёт легендарный
// уровень нужной строки, и трейты не нужны. Здесь системы навыков нет, поэтому трейты.
