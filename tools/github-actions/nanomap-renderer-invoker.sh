...
tools/github-actions/nanomap-renderer minimap -w 2040 -h 2040 --disable icon-smoothing "./_maps/map_files/event/Station/coldcolony.dmm"
...
mv "coldcolony_nanomap_z1.png" "Malta_nanomap_z1.png"
cd "../../"
...
cp "data/nanomaps/Malta_nanomap_z1.png" "icons/_nanomaps"
