...
/datum/heretic_knowledge/limited_amount/starting/base_void/recipe_snowflake_check(mob/living/user, list/atoms, list/selected_atoms, turf/simulated/loc)
	if(loc.return_air().temperature() < T0C)
		return ..()
...
/datum/heretic_knowledge/cold_snap
	...
	desc = "Даёт вам иммунитет к холоду, низкому давлению и избавляет от необходимости дышать."
...
/datum/weather/void_storm
	...
	weather_message = "Вы чувствуете, как воздух вокруг становится холоднее... Вы чувствуете сладкие объятия пустоты..."
