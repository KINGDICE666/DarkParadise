...
/obj/effect/proc_holder/spell/pointed/sword_fling/can_cast(mob/user = usr, charge_check = TRUE, show_message = FALSE)
...
/obj/effect/proc_holder/spell/pointed/sword_fling/cast(turf/cast_on, mob/user = usr)
	. = ..()
