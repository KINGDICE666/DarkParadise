...
/datum/proximity_monitor/advanced/heretic_arena/New(atom/_host, range, works_when_not_on_turf = FALSE)
	. = ..()
...
/datum/proximity_monitor/advanced/heretic_arena/proc/on_teleport(atom/teleportee, atom/destination)
