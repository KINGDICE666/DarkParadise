...
function startWebSocketServer(byondPort, nodePort) {
    ...
    // Browser-facing static page + WebSocket signaling (HTTPS, reachable from
    // the LAN / Radmin / wherever players come from). BYOND -> Node now flows
    // through the named pipe in ByondServer.js, no HTTP bridge needed here.
