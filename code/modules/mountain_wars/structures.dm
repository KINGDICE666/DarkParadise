...
// MARK: Сиденья
// Общее поведение лавок и постов режима: намертво приварено и не разбирается.
//
// Видимость здесь не трогаем. Невидимым сиденье нужно только в вертолёте, где нутро
// нарисовано целиком вместе с лавками, — там его и гасим, см. heli_bench в helicopter.dm.
// Держать alpha = 0 на общем родителе нельзя: сиденья техники видимые, и гасли вместе с
// ним.
