...
GLOBAL_LIST_INIT(sandstone_recipes, list ( \
	new/datum/stack_recipe("pile of dirt", /obj/machinery/hydroponics/soil, 3, time = 1 SECONDS, one_per_turf = 1, on_floor = 1), \
...
GLOBAL_LIST_INIT(tranquillite_recipes, list ( \
	new/datum/stack_recipe("invisible wall", /obj/structure/barricade/mime, 5, one_per_turf = 1, on_floor = 1, time = 5 SECONDS), \
	null, \
...
GLOBAL_LIST_INIT(abductor_recipes, list ( \
	...
	new/datum/stack_recipe("alien airlock assembly", /obj/structure/door_assembly/door_assembly_abductor, 4, time = 2 SECONDS, one_per_turf = 1, on_floor = 1), \
	null, \
