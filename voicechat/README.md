...
Windows support requires Node.js and a compiled BYOND socket DLL.
...
1. Install Node.js.
2. From `voicechat/node`, run `npm install`.
3. Start the game normally. The voice chat subsystem launches Node when `enable_voicechat` is enabled.

#### building library components

1. Navigate to `voicechat/pipes/windows/byondsocket/`.
