...
tools/github-actions/dmm-tools-para minimap --enable nanomaps --width 2040 --height 2040 --disable icon-smoothing "./_maps/map_files/event/Station/coldcolony.dmm"
...
mv "data/minimaps/coldcolony-1.png" "icons/_nanomaps/Malta_nanomap_z1.png"
